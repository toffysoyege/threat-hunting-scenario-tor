...
6. Create a folder on your desktop called ```torshoppinglist.txt``` and put a few fake (illicit) items in there
7. Delete the file.
8. Recover the file
9. Rename the file to ```torshoppinglist.txt``` to ```tor-shopping-list.txt```
10. Delete the file.
...
## Created By:
- **Author Name**: Toffy Soyege 
- **Author Contact**: https://www.linkedin.com/in/toffysoyege/
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `March 30th, 2025`  | `Toffy Soyege`   
